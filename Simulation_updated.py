...
size_of_cliques = d+1
print("You chose a graph with ", number_of_cliques, " cliques, each with a size of",size_of_cliques," nodes.")
...
if chosen_cut == 1:
    ...
    print("How many adjacent cliques should be in the cut? Choose from 1 to maximum of ", number_of_cliques,".")
...
expected_strains_alternative = [cut_strains[0]] + expected_strains_alternative[:-1]
